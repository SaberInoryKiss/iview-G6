            ...
            return{
                ...
                option :{
                    ...
                    globe: {
                        ...
                        silent: true,
                        environment: require("@/assets/3DGlobe/starfield.jpg"), //背景
                        baseTexture: require("@/assets/3DGlobe/earth.jpg"),
                        heightTexture: require("@/assets/3DGlobe/world.topo.bathy.200401.jpg"),
                        // heightTexture: require("@/assets/3DGlobe/bathymetry_bw_composite_4k.jpg"), //地球的整个纹路
                        shading: 'realistic',
                        // light: {
                        //     main: {
                        //         color: '#fff',
                        ...
                        layers: [{
                            type: 'blend',
                            blendTo: 'emission',
                            texture: require("@/assets/3DGlobe/night.jpg")
                        }, 
                        // {
                        //     type: 'overlay',
                        //     texture: require("@/assets/3DGlobe/clouds.png"),
                        //     shading: 'lambert',
                        //     distance: 5
                        // }
                        ],
                ...
                mapOption: {
                    ...
                    backgroundColor: '#00456b',//当和立体球形贴图是海洋的颜色
                    visualMap: {
                        show: false,
                        min: 0,
                        max: 100000
                            ...
                            itemStyle: {
                                normal: {
                                    ...
                                    areaColor: {
                                        ...
                                        colorStops: [
                                            {
                                            offset: 0.2, color: 'RGB(136,175,67)' // 0% 处的颜色
                                        }, 
                                        {
                                            offset: 0.8, color: 'RGB(100,204,88)' // 100% 处的颜色
                                        }
                                        ],
